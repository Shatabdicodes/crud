...
export default function App() {
  ...
  return (
    /* OUTER ARC WRAPPER — the whole app inside a big rounded rectangle */
    <div style={{
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        .inp {
          ...
          color: #c8d0e8; padding: 7px 12px; border-radius: 8px;
        ...
        .field-label {
          font-size: 9.5px; font-weight: 700; color: #4a5272;
          letter-spacing: 0.13em; display: block; margin-bottom: 4px; text-transform: uppercase;
        }
        ...
        .radio-label {
          ...
          padding: 6px 11px; border-radius: 8px; font-weight: 500;
        ...
        .terms-row { display: flex; align-items: center; gap: 8px; margin-bottom: 12px; }
        .terms-row input[type=checkbox] { width: 14px; height: 14px; accent-color: #4f6ef7; cursor: pointer; flex-shrink: 0; }
        ...
        th {
          ...
          letter-spacing: 0.14em; padding: 8px 10px; text-align: left;
          border-bottom: 1px solid #181c2e; text-transform: uppercase;
        }
        td { padding: 9px 10px; border-bottom: 1px solid #161928; vertical-align: middle; }
        tr:last-child td { border-bottom: none; }
        tr:hover td { background: rgba(255,255,255,0.012); }
        .badge-male   { background: #12203e; color: #60a5fa; padding: 3px 11px; border-radius: 20px; font-size: 11px; font-weight: 700; display:inline-block; }
        .badge-female { background: #22103a; color: #c084fc; padding: 3px 11px; border-radius: 20px; font-size: 11px; font-weight: 700; display:inline-block; }
        .badge-other  { background: #0e2420; color: #34d399; padding: 3px 11px; border-radius: 20px; font-size: 11px; font-weight: 700; display:inline-block; }
        .agree-icon-box   { background: #133a20; border-radius: 4px; width: 18px; height: 18px; display:flex; align-items:center; justify-content:center; font-size: 11px; color: #22c55e; flex-shrink:0; }
        .decline-icon-box { background: #3a1010; border-radius: 4px; width: 18px; height: 18px; display:flex; align-items:center; justify-content:center; font-size: 11px; color: #ef4444; flex-shrink:0; }
        .agree-text   { color: #22c55e; font-size: 11px; font-weight: 700; }
        .decline-text { color: #ef4444; font-size: 11px; font-weight: 700; }
        ...
        .stat-chip {
          ...
          padding: 4px 13px; font-size: 12px; font-weight: 600; color: #6a729a;
      ...
      <div style={{
        ...
        boxShadow: "0 0 0 6px #0d0f1a, 0 0 60px rgba(79,110,247,0.08)",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px", flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div style={{ width: 40, height: 40, borderRadius: "50%", background: "linear-gradient(135deg,#4f6ef7,#6c63ff)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 19, flexShrink: 0 }}>👤</div>
            <h1 style={{ fontSize: "22px", fontWeight: 900, color: "#fff", letterSpacing: "-0.5px" }}>
              User <span style={{ color: "#4f72ff" }}>Management</span>
            </h1>
          </div>
          <div style={{ background: "#10131e", border: "1.5px solid #20243c", borderRadius: "20px", padding: "6px 16px", fontSize: "12px", fontWeight: 700, color: "#c8d0e8" }}>
            {total} Users
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: "14px", flex: 1, minHeight: 0 }}>
          ...
          {/* FORM CARD */}
          <div className="inner-card" style={{ display: "flex", flexDirection: "column", overflow: "hidden" }}>
          ...
          <div className="inner-card" style={{ display: "flex", flexDirection: "column", overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", gap: "7px", marginBottom: "12px", flexWrap: "wrap", flexShrink: 0 }}>
            ...
            <div style={{ flex: 1, overflowY: "auto", overflowX: "auto" }}>
              <table>
                <thead>
                  <tr>
                    <th>#</th><th>NAME</th><th>EMAIL</th><th>PASSWORD</th><th>AGE</th><th>GENDER</th><th>T&C</th><th>ACTIONS</th>
                  </tr>
                </thead>
                <tbody>
                  {users.map((u, i) => (
                    <tr key={u.id}>
                      ...
                      <td>
                        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                          <div style={{ width: 32, height: 32, borderRadius: "50%", background: getColor(u.name), display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 800, color: "#fff", flexShrink: 0 }}>
                            {getInitials(u.name)}
                          </div>
                          <span style={{ fontWeight: 700, color: "#d8dff5" }}>{u.name}</span>
                        </div>
                      </td>
                      <td style={{ color: "#5a6280" }}>{u.email}</td>
                      <td style={{ color: "#2e3450", letterSpacing: "3px" }}>••••••</td>
